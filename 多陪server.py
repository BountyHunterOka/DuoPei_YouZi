...
HEADERS = {
    ...
    "authorization-token": "d50562ebf6cc43ddad32d4293e6e7581",
    "sid": "47",
...
def extract_order_id(decrypted_json_str):
    ...
    try:
        ...
        sensitive_words = ['腿','胸','不续单','狱卒','玉足','欲姐','萝莉','广东','四川','照片','黑丝','白丝','四爱','哄睡','我不说话','脚','看看','主动','麦当劳','调','退伍','属性','新人','游戏','三角洲','原神','英雄联盟','吃鸡','王者荣耀','金铲铲','和平精英','星巴克','麦当劳s和m','麦当劳s','麦当劳m']
